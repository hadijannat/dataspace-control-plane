---
title: "Docs Teammate Guide"
summary: "Working conventions for teammates updating the docs/ governance and explanation layer."
owner: docs-lead
...
- Do not create a second docs site configuration outside the repository-root
  `mkdocs.yml`.
