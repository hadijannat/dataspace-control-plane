...
- No docs site config exists yet. If a site is scaffolded later, keep its config under `docs/` and record the exact path in this guidebook and `docs/AGENTS.md` instead of inventing parallel locations.
...
- Expected command once scaffolded: `pytest tests/unit -k docs_consistency`
