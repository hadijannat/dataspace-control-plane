...
- [`../../PLANS.md`](../../PLANS.md) defines how to write execution plans for large or cross-directory work.
- [`../../.agents/skills/`](../../.agents/skills/) contains repo-local reusable workflows.
