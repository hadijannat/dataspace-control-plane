---
title: "Docs Agent Working Model"
summary: "Ownership boundary, rules, and verification contract for the docs/ explanation layer."
owner: docs-lead
...
- Treat the repository-root `mkdocs.yml` as the canonical site configuration for
  the published docs corpus.
